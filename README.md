...
* [EMQ X](https://github.com/emqx/emqx) ⭐ 16,616 | 🐛 253 | 🌐 Erlang | 📅 2026-08-12 - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
* [Emitter](https://github.com/emitter-io/emitter) ⭐ 4,003 | 🐛 16 | 🌐 Go | 📅 2026-04-29 - A distributed, scalable and fault-tolerant publish-subscribe messaging platform based on MQTT protocol and featuring message storage.
* [Aedes](https://github.com/moscajs/aedes) ⭐ 1,966 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-12 - Barebone MQTT broker that can run on any stream server, the node way.
...
* [hbmqtt Broker](https://github.com/beerfactory/hbmqtt) ⭐ 819 | 🐛 103 | 🌐 Python | 📅 2022-07-24 - Python MQTT broker using asyncio.

<!--lint enable double-link-->

* [Moquette](https://github.com/moquette-io/moquette) ⭐ 2,450 | 🐛 138 | 🌐 Java | 📅 2026-08-01 - Java MQTT lightweight broker.
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 54 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - Async MQTT v5.0 broker in Rust with TCP, TLS, WebSocket, and QUIC transport, plus authentication, ACL, bridging, and session persistence.

<!--lint enable double-link-->

* [tbmq](https://github.com/thingsboard/tbmq) ⭐ 748 | 🐛 11 | 🌐 Java | 📅 2026-08-12 - Open-source, scalable, fault-tolerant and durable messaging broker for millions of IoT devices.
...
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,586 | 🐛 66 | 🌐 C | 📅 2026-08-12 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoT DC3](https://github.com/pnoker/iot-dc3) ⭐ 666 | 🐛 34 | 🌐 Java | 📅 2026-08-11 - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
* [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents](https://github.com/ForestHubAI/edge-agents) ⭐ 96 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-29 orchestrates AI agents on Linux edge gateways with MQTT as a first-class workflow transport, running offline with local SLMs alongside cloud LLMs.
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,016 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-13 - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 712 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 - Simple lightweight terminal based MQTT monitor and publisher.
...
* [MQTT CLI](https://github.com/hivemq/mqtt-cli) ⭐ 362 | 🐛 12 | 🌐 Java | 📅 2026-08-12 - A command line interface for connecting various MQTT clients supporting MQTT 5.0 and 3.1.1.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 141 | 🐛 8 | 🌐 Go | 📅 2026-07-28 - Multi-protocol mock server with a built-in MQTT broker supporting QoS 0-2, retained messages, topic patterns, and device simulation for IoT development and testing.
...
* [Python MQTT Client Shell](https://github.com/bapowell/python-mqtt-client-shell) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2019-08-23 - Text console-based, interactive shell for exercising various tasks associated with MQTT client communications.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 30 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - A fast, terminal-UI MQTT client written in Rust — inspired by MQTT Explorer, but keyboard-driven and living in your terminal.
...
* [VSMQTT](https://github.com/rpdswtk/vsmqtt) ⭐ 17 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-27 - Simple MQTT client integrated in Visual Studio Code.
...
* [homie-home-assistant-discovery](https://github.com/labodj/homie-home-assistant-discovery) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-29 - Node.js CLI and library that maps Homie MQTT metadata to Home Assistant MQTT discovery payloads.
* [MQTTForge](https://github.com/ibrahimilkhan/mqtt-forge) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - Test console that builds a broker's topics into a live tree, shows every frame on the wire, and publishes by hand. Desktop app for macOS, Windows and Linux, or a single Docker image.
...
* [mqttv5](https://github.com/LabOverWire/mqtt-lib) ⭐ 54 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - Unified MQTT v5.0 CLI for publishing, subscribing, running a broker, and benchmarking with multi-transport support.
...
* [aiomqtt](https://github.com/empicano/aiomqtt) ⭐ 569 | 🐛 13 | 🌐 Python | 📅 2026-04-23 - The idiomatic asyncio MQTT client.
* [gmqtt](https://github.com/wialon/gmqtt) ⭐ 450 | 🐛 28 | 🌐 Python | 📅 2026-06-14 - Python MQTT v5.0 client (asyncio-based).

<!--lint disable double-link-->

* [hbmqtt Client](https://github.com/beerfactory/hbmqtt) ⭐ 819 | 🐛 103 | 🌐 Python | 📅 2022-07-24 - Python MQTT client using asyncio.
...
* [hivemq-mqtt-client](https://github.com/hivemq/hivemq-mqtt-client) ⭐ 1,111 | 🐛 79 | 🌐 Java | 📅 2026-08-07 - High-performance Java MQTT client library with different API flavours for MQTT 5.0 and 3.1.1.

### Erlang or Elixir

* [emqttc](https://github.com/emqx/emqtt) ⭐ 438 | 🐛 39 | 🌐 Erlang | 📅 2026-07-29 - Asynchronous Erlang MQTT Client.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,052 | 🐛 190 | 🌐 C# | 📅 2026-08-09 - MQTT client and broker .NET implementations.
* [HiveMQtt](https://github.com/hivemq/hivemq-mqtt-client-dotnet) ⭐ 96 | 🐛 9 | 🌐 C# | 📅 2026-08-04 - MQTT 5.0 compliant secure client with automatic back pressure management and TCP & WebSocket transport support.

### Delphi

* [delphi-mqtt](https://github.com/pjde/delphi-mqtt) ⭐ 162 | 🐛 11 | 🌐 Pascal | 📅 2020-03-29 - MQTT server and client components.
...
* [luamqtt](https://github.com/xHasKx/luamqtt/) ⭐ 186 | 🐛 9 | 🌐 Lua | 📅 2026-07-05 - Pure-lua MQTT v3.1.1 and v5.0 client.
...
* [ruby-mqtt](https://github.com/njh/ruby-mqtt) ⭐ 561 | 🐛 31 | 🌐 Ruby | 📅 2026-05-08 - Pure Ruby gem that implements the MQTT protocol.
...
* [mqtt-typed-client](https://github.com/holovskyi/mqtt-typed-client) ⭐ 9 | 🐛 7 | 🌐 Rust | 📅 2026-07-28 - Type-safe async MQTT client built on rumqttc, with derive macros for typed topics, automatic (de)serialization, and tree-based message routing.

<!--lint disable double-link-->

* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 54 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - Complete async MQTT v5.0 client and broker library for Rust with TCP, TLS, WebSocket, and QUIC support.
...
* [Moscapsule](https://github.com/flightonary/Moscapsule) ⭐ 274 | 🐛 40 | 🌐 C | 📅 2026-08-08 - MQTT Client for iOS written in Swift.
...
* [Sonoff-Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,688 | 🐛 13 | 🌐 C | 📅 2026-08-12 - Firmware for ESP8266 devices with web-based configuration. ≈500 devices supported (not only Sonoffs).
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,074 | 🐛 50 | 🌐 C++ | 📅 2026-08-10 - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
* [fritz2mqtt](https://github.com/akentner/fritz2mqtt) ⭐ 7 | 🐛 3 | 🌐 JavaScript | 📅 2026-03-01 - Connect FRITZ!Box to MQTT.
...
* [Bambuddy](https://github.com/maziggy/bambuddy) ⭐ 2,780 | 🐛 141 | 🌐 Python | 📅 2026-08-13 - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
...
* [huABus](https://github.com/arboeh/huABus) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - Home Assistant application (Add-on) and MQTT bridge for Huawei solar inverters (SUN2000/3000/5000).
...
* [mqtt2homekit](https://github.com/forty2/mqtt2homekit) ⭐ 39 | 🐛 4 | 🌐 JavaScript | 📅 2018-01-05 - Roughly the opposite of [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) ⭐ 357 | 🐛 39 | 🌐 JavaScript | 📅 2022-02-04: Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.

<!--lint enable double-link-->

* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,496 | 🐛 462 | 🌐 TypeScript | 📅 2026-08-12 - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
* [zwavejs2mqtt](https://github.com/zwave-js/zwavejs2mqtt) ⭐ 1,235 | 🐛 119 | 🌐 Vue | 📅 2026-08-10 - Zwave to Mqtt gateway and Control Panel Web UI.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) ⭐ 357 | 🐛 39 | 🌐 JavaScript | 📅 2022-02-04 - Interface between [HAP-NodeJS](https://github.com/homebridge/HAP-NodeJS) ⭐ 2,722 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-08 and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
...
* [she - smart home engine](https://github.com/hobbyquaker/she) ⭐ 8 | 🐛 0 | 🌐 Svelte | 📅 2026-06-22 - Scriptable smart home automation engine with AI assistance.
...
* [lgtv2mqtt](https://github.com/hobbyquaker/lgtv2mqtt) ⭐ 109 | 🐛 8 | 🌐 JavaScript | 📅 2023-01-17 - Interface between LG WebOS Smart TVs and MQTT.
...
* [sonos2mqtt](https://github.com/svrooij/sonos2mqtt) ⭐ 83 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-06 - A bridge between Sonos and MQTT.
...
* [rpi-mqtt-monitor](https://github.com/hjelev/rpi-mqtt-monitor) ⭐ 316 | 🐛 7 | 🌐 Python | 📅 2026-06-26 - The easiest way to track your Raspberry Pi or Ubuntu computer system health and performance in Home Assistant via MQTT.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,529 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-12 - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
* [unifi2mqtt](https://github.com/hobbyquaker/unifi2mqtt) ⭐ 77 | 🐛 14 | 🌐 JavaScript | 📅 2020-08-07 - Publish connected clients from Ubiquiti Unifi to MQTT.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,109 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
* [node-red-dashboard](https://github.com/node-red/node-red-dashboard) ⭐ 1,405 | 🐛 93 | 🌐 HTML | 📅 2025-08-07 - A dashboard UI for Node-RED.
...
* [MQTT-Tiles](https://github.com/flespi-software/MQTT-Tiles) ⭐ 113 | 🐛 21 | 🌐 Vue | 📅 2026-06-23 - MQTT-based IoT dashboard visualization tool. Allows easy dashboards sharing. Works with any MQTT broker supporting the WSS protocol.
...
* [mqtt-dashboard](https://github.com/jmischler72/mqtt-dashboard) ⭐ 16 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-12 - Self-hostable MQTT dashboard/explorer with drag-and-drop panels like cron, button, log and topic browser to help interact and monitor MQTT topics.
...
* [MQTT-PWN](https://github.com/akamai-threat-research/mqtt-pwn) ⭐ 449 | 🐛 16 | 🌐 Python | 📅 2024-08-09 - IoT Broker penetration-testing and security assessment operations.
