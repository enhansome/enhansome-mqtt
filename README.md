...
* [EMQ X](https://github.com/emqx/emqx) ⭐ 16,723 | 🐛 205 | 🌐 Erlang | 📅 2026-09-15 - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
...
* [Aedes](https://github.com/moscajs/aedes) ⭐ 1,967 | 🐛 93 | 🌐 JavaScript | 📅 2026-09-15 - Barebone MQTT broker that can run on any stream server, the node way.
...
* [Moquette](https://github.com/moquette-io/moquette) ⭐ 2,456 | 🐛 140 | 🌐 Java | 📅 2026-08-31 - Java MQTT lightweight broker.
...
* [tbmq](https://github.com/thingsboard/tbmq) ⭐ 762 | 🐛 7 | 🌐 Java | 📅 2026-09-15 - Open-source, scalable, fault-tolerant and durable messaging broker for millions of IoT devices.
...
* [TrailMQ](https://github.com/RainerGewalt/TrailMQ) ⭐ 5 | 🐛 11 | 🌐 Shell | 📅 2026-09-14 - Self-hosted MQTT broker with policy enforcement and a reviewable record of broker decisions, for regulated and industrial systems.
...
* [Vert.x MQTT Server](https://github.com/vert-x3/vertx-mqtt) ⭐ 214 | 🐛 45 | 🌐 Java | 📅 2026-09-15 - Vert.x component to handle connections, communication and messages exchange with remote MQTT clients.

<!--lint enable double-link-->

* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,615 | 🐛 69 | 🌐 C | 📅 2026-09-15 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoT DC3](https://github.com/pnoker/iot-dc3) ⭐ 1,264 | 🐛 32 | 🌐 Java | 📅 2026-09-08 - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,056 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-15 - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 727 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - Simple lightweight terminal based MQTT monitor and publisher.
...
* [MQTT CLI](https://github.com/hivemq/mqtt-cli) ⭐ 363 | 🐛 13 | 🌐 Java | 📅 2026-09-15 - A command line interface for connecting various MQTT clients supporting MQTT 5.0 and 3.1.1.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - A fast, terminal-UI MQTT client written in Rust — inspired by MQTT Explorer, but keyboard-driven and living in your terminal.
...
* [Vert.x Client](https://github.com/vert-x3/vertx-mqtt) ⭐ 214 | 🐛 45 | 🌐 Java | 📅 2026-09-15 - Vert.x component that provides methods for connecting/disconnecting to a broker, publishing messages and subscribing to topics.

<!--lint enable double-link-->

### Java

* [hivemq-mqtt-client](https://github.com/hivemq/hivemq-mqtt-client) ⭐ 1,117 | 🐛 78 | 🌐 Java | 📅 2026-09-14 - High-performance Java MQTT client library with different API flavours for MQTT 5.0 and 3.1.1.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,063 | 🐛 201 | 🌐 C# | 📅 2026-08-09 - MQTT client and broker .NET implementations.
...
* [Sonoff-Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,760 | 🐛 16 | 🌐 C | 📅 2026-09-13 - Firmware for ESP8266 devices with web-based configuration. ≈500 devices supported (not only Sonoffs).
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,095 | 🐛 48 | 🌐 C++ | 📅 2026-09-14 - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
* [Bambuddy](https://github.com/maziggy/bambuddy) ⭐ 2,965 | 🐛 236 | 🌐 Python | 📅 2026-09-15 - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
...
* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,635 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-14 - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
* [zwavejs2mqtt](https://github.com/zwave-js/zwavejs2mqtt) ⭐ 1,238 | 🐛 117 | 🌐 Vue | 📅 2026-09-15 - Zwave to Mqtt gateway and Control Panel Web UI.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,669 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-14 - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
* [unifi2mqtt](https://github.com/hobbyquaker/unifi2mqtt) ⭐ 79 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-10 - Publish connected clients from Ubiquiti Unifi to MQTT.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,181 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
