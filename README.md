...
* [EMQ X](https://github.com/emqx/emqx) ⭐ 16,656 | 🐛 185 | 🌐 Erlang | 📅 2026-08-26 - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
...
* [Eclipse Amlen](https://github.com/eclipse/amlen) ⭐ 53 | 🐛 19 | 🌐 C | 📅 2026-07-26 - A scalable, secure, easy to use message broker that can be used for IoT, web and mobile use-cases. Open-sourced from IBM MessageSight.
...
* [tbmq](https://github.com/thingsboard/tbmq) ⭐ 752 | 🐛 11 | 🌐 Java | 📅 2026-08-26 - Open-source, scalable, fault-tolerant and durable messaging broker for millions of IoT devices.
...
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,592 | 🐛 64 | 🌐 C | 📅 2026-08-24 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoT DC3](https://github.com/pnoker/iot-dc3) ⭐ 1,069 | 🐛 32 | 🌐 Java | 📅 2026-08-26 - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,032 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 44 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - A fast, terminal-UI MQTT client written in Rust — inspired by MQTT Explorer, but keyboard-driven and living in your terminal.
...
* [hivemq-mqtt-client](https://github.com/hivemq/hivemq-mqtt-client) ⭐ 1,113 | 🐛 76 | 🌐 Java | 📅 2026-08-26 - High-performance Java MQTT client library with different API flavours for MQTT 5.0 and 3.1.1.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,062 | 🐛 190 | 🌐 C# | 📅 2026-08-09 - MQTT client and broker .NET implementations.
...
* [CocoaMQTT](https://github.com/emqx/CocoaMQTT) ⭐ 1,748 | 🐛 112 | 🌐 Swift | 📅 2026-07-31 - MQTT for iOS and macOS written with Swift.
...
* [Sonoff-Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,729 | 🐛 11 | 🌐 C | 📅 2026-08-25 - Firmware for ESP8266 devices with web-based configuration. ≈500 devices supported (not only Sonoffs).
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,082 | 🐛 50 | 🌐 C++ | 📅 2026-08-25 - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
* [Bambuddy](https://github.com/maziggy/bambuddy) ⭐ 2,854 | 🐛 166 | 🌐 Python | 📅 2026-08-26 - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 156 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-26 - BLE-to-MQTT bridge for smart scales (23 brands) with Home Assistant auto-discovery. Reads weight + impedance, calculates body composition, publishes all 11 metrics with LWT and display precision. [Website](https://blescalesync.dev).
...
* [cul2mqtt](https://github.com/hobbyquaker/cul2mqtt) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 - Interface between [Busware CUL](https://shop.busware.de/product_info.php/cPath/1/products_id/29) (868MHz RF-Devices like ELV FS20, HMS, EM, etc.) and MQTT.
...
* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,572 | 🐛 455 | 🌐 TypeScript | 📅 2026-08-26 - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
* [zwavejs2mqtt](https://github.com/zwave-js/zwavejs2mqtt) ⭐ 1,235 | 🐛 122 | 🌐 Vue | 📅 2026-08-25 - Zwave to Mqtt gateway and Control Panel Web UI.
...
* [she - smart home engine](https://github.com/hobbyquaker/she) ⭐ 9 | 🐛 0 | 🌐 Svelte | 📅 2026-08-22 - Scriptable smart home automation engine with AI assistance.
...
* [lgtv2mqtt](https://github.com/hobbyquaker/lgtv2mqtt) ⭐ 111 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-22 - Interface between LG WebOS Smart TVs and MQTT.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,583 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,127 | 🐛 161 | 🌐 C++ | 📅 2026-08-10 - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
