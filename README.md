...
* [MQTT community wiki](https://github.com/mqtt/mqtt.org/wiki) ⭐ 5,122 | 🐛 25 | 🌐 SCSS | 📅 2026-04-16
...
* [EMQ X](https://github.com/emqx/emqx) ⭐ 16,706 | 🐛 188 | 🌐 Erlang | 📅 2026-09-10 - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
* [Emitter](https://github.com/emitter-io/emitter) ⭐ 4,006 | 🐛 16 | 🌐 Go | 📅 2026-04-29 - A distributed, scalable and fault-tolerant publish-subscribe messaging platform based on MQTT protocol and featuring message storage.
* [Aedes](https://github.com/moscajs/aedes) ⭐ 1,968 | 🐛 94 | 🌐 JavaScript | 📅 2026-09-08 - Barebone MQTT broker that can run on any stream server, the node way.
* [comqtt](https://github.com/wind-c/comqtt) ⭐ 1,178 | 🐛 5 | 🌐 Go | 📅 2026-09-06 - A lightweight, high-performance go mqtt server(v3.0|v3.1.1|v5.0) supporting distributed cluster.
...
* [Moquette](https://github.com/moquette-io/moquette) ⭐ 2,454 | 🐛 141 | 🌐 Java | 📅 2026-08-31 - Java MQTT lightweight broker.
...
* [Keel MQTT Gateway](https://github.com/keel-iot/keel-mqtt-gateway) ⭐ 6 | 🐛 11 | 🌐 Go | 📅 2026-09-02 - Distributed, cloud-native MQTT broker in Go built on mochi-mqtt, using Raft for strongly-consistent session ownership and ACL, with a gossip-backed routing table (Olric).
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 58 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - Async MQTT v5.0 broker in Rust with TCP, TLS, WebSocket, and QUIC transport, plus authentication, ACL, bridging, and session persistence.

<!--lint enable double-link-->

* [tbmq](https://github.com/thingsboard/tbmq) ⭐ 761 | 🐛 7 | 🌐 Java | 📅 2026-09-10 - Open-source, scalable, fault-tolerant and durable messaging broker for millions of IoT devices.
...
* [TrailMQ](https://github.com/RainerGewalt/TrailMQ) ⭐ 5 | 🐛 11 | 🌐 Shell | 📅 2026-08-15 - Self-hosted MQTT broker with policy enforcement and a reviewable record of broker decisions, for regulated and industrial systems.
...
* [Vert.x MQTT Server](https://github.com/vert-x3/vertx-mqtt) ⭐ 214 | 🐛 46 | 🌐 Java | 📅 2026-09-10 - Vert.x component to handle connections, communication and messages exchange with remote MQTT clients.

<!--lint enable double-link-->

* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,614 | 🐛 63 | 🌐 C | 📅 2026-09-09 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoT DC3](https://github.com/pnoker/iot-dc3) ⭐ 1,247 | 🐛 32 | 🌐 Java | 📅 2026-09-08 - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,049 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 725 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - Simple lightweight terminal based MQTT monitor and publisher.
...
* [MQTT CLI](https://github.com/hivemq/mqtt-cli) ⭐ 363 | 🐛 13 | 🌐 Java | 📅 2026-09-10 - A command line interface for connecting various MQTT clients supporting MQTT 5.0 and 3.1.1.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 144 | 🐛 11 | 🌐 Go | 📅 2026-09-10 - Multi-protocol mock server with a built-in MQTT broker supporting QoS 0-2, retained messages, topic patterns, and device simulation for IoT development and testing.
...
* [MQTT Board](https://github.com/flespi-software/MQTT-Board) ⭐ 104 | 🐛 7 | 🌐 Vue | 📅 2026-06-21 - Open-source diagnostic-oriented MQTT client tool.
...
* [mqtt-mirror](https://github.com/4nte/mqtt-mirror) ⭐ 43 | 🐛 5 | 🌐 Go | 📅 2026-09-05 - Mirror MQTT traffic from one broker to another. Available as a CLI tool, Helm chart or Docker image.
...
* [VSMQTT](https://github.com/rpdswtk/vsmqtt) ⭐ 17 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 - Simple MQTT client integrated in Visual Studio Code.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - A fast, terminal-UI MQTT client written in Rust — inspired by MQTT Explorer, but keyboard-driven and living in your terminal.
...
* [dsh-mqtt](https://github.com/UllrAI/dsh-mqtt) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22 - MQTT protocol driver and long-running agent worker gateway for DeepSeek Harness, enabling remote clients to submit, steer, cancel, and observe agent work.
...
* [homie-home-assistant-discovery](https://github.com/labodj/homie-home-assistant-discovery) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - Node.js CLI and library that maps Homie MQTT metadata to Home Assistant MQTT discovery payloads.
* [MQTTForge](https://github.com/ibrahimilkhan/mqtt-forge) ⭐ 0 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - Test console that builds a broker's topics into a live tree, shows every frame on the wire, and publishes by hand. Desktop app for macOS, Windows and Linux, or a single Docker image.
...
* [mqttv5](https://github.com/LabOverWire/mqtt-lib) ⭐ 58 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - Unified MQTT v5.0 CLI for publishing, subscribing, running a broker, and benchmarking with multi-transport support.
...
* [aiomqtt](https://github.com/empicano/aiomqtt) ⭐ 574 | 🐛 14 | 🌐 Python | 📅 2026-04-23 - The idiomatic asyncio MQTT client.
...
* [Vert.x Client](https://github.com/vert-x3/vertx-mqtt) ⭐ 214 | 🐛 46 | 🌐 Java | 📅 2026-09-10 - Vert.x component that provides methods for connecting/disconnecting to a broker, publishing messages and subscribing to topics.

<!--lint enable double-link-->

### Java

* [hivemq-mqtt-client](https://github.com/hivemq/hivemq-mqtt-client) ⭐ 1,117 | 🐛 78 | 🌐 Java | 📅 2026-09-10 - High-performance Java MQTT client library with different API flavours for MQTT 5.0 and 3.1.1.

### Erlang or Elixir

* [emqttc](https://github.com/emqx/emqtt) ⭐ 439 | 🐛 38 | 🌐 Erlang | 📅 2026-09-10 - Asynchronous Erlang MQTT Client.
* [mqttex](https://github.com/alfert/mqttex) ⭐ 45 | 🐛 2 | 🌐 Elixir | 📅 2015-05-14 - MQTT implementation in Elixir.

### Ballerina

* [ballerina-mqtt](https://github.com/ballerina-platform/module-ballerina-mqtt) ⭐ 106 | 🐛 0 | 🌐 Java | 📅 2026-09-10 - Ballerina MQTT client based on paho-mqtt.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,061 | 🐛 197 | 🌐 C# | 📅 2026-08-09 - MQTT client and broker .NET implementations.
* [HiveMQtt](https://github.com/hivemq/hivemq-mqtt-client-dotnet) ⭐ 96 | 🐛 9 | 🌐 C# | 📅 2026-09-07 - MQTT 5.0 compliant secure client with automatic back pressure management and TCP & WebSocket transport support.

### Delphi

* [delphi-mqtt](https://github.com/pjde/delphi-mqtt) ⭐ 164 | 🐛 11 | 🌐 Pascal | 📅 2020-03-29 - MQTT server and client components.
* [TMQTTClient](https://github.com/jamiei/Delphi-TMQTT2) ⭐ 27 | 🐛 7 | 🌐 Pascal | 📅 2015-11-11 - MQTT Client Library for Delphi. Alpha and long term unmaintained.
...
* [luamqtt](https://github.com/xHasKx/luamqtt/) ⭐ 184 | 🐛 9 | 🌐 Lua | 📅 2026-07-05 - Pure-lua MQTT v3.1.1 and v5.0 client.
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 58 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - Complete async MQTT v5.0 client and broker library for Rust with TCP, TLS, WebSocket, and QUIC support.

<!--lint enable double-link-->

### Swift

* [CocoaMQTT](https://github.com/emqx/CocoaMQTT) ⭐ 1,752 | 🐛 111 | 🌐 Swift | 📅 2026-09-08 - MQTT for iOS and macOS written with Swift.
...
* [pubsubclient](https://github.com/knolleary/pubsubclient) ⭐ 4,015 | 🐛 568 | 🌐 C++ | 📅 2026-06-10 - A client library for the Arduino Ethernet Shield that provides support for MQTT.
...
* [Espurna](https://github.com/xoseperez/espurna) ⭐ 3,054 | 🐛 302 | 🌐 C++ | 📅 2026-04-15 - <abbr title="Home automation">HA</abbr> firmware for ESP8266-based devices with rich web UI and ≈120 devices supported out of the box.
...
* [Sonoff-Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,751 | 🐛 14 | 🌐 C | 📅 2026-09-10 - Firmware for ESP8266 devices with web-based configuration. ≈500 devices supported (not only Sonoffs).
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,090 | 🐛 47 | 🌐 C++ | 📅 2026-09-08 - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
* [mqttwarn](https://github.com/jpmens/mqttwarn) ⭐ 979 | 🐛 40 | 🌐 Python | 📅 2026-07-22 - Use with [carbon](https://mqttwarn.readthedocs.io/en/latest/notifier-catalog.html#carbon) plugin.
...
* [Bambuddy](https://github.com/maziggy/bambuddy) ⭐ 2,939 | 🐛 225 | 🌐 Python | 📅 2026-09-10 - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 170 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 - BLE-to-MQTT bridge for smart scales (23 brands) with Home Assistant auto-discovery. Reads weight + impedance, calculates body composition, publishes all 11 metrics with LWT and display precision. [Website](https://blescalesync.dev).
...
* [hm2mqtt.js](https://github.com/hobbyquaker/hm2mqtt.js) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-07 - Interface between EQ-3's Homematic line of smarthome devices and MQTT. Supports Homematic IP.
...
* [cul2mqtt](https://github.com/hobbyquaker/cul2mqtt) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-28 - Interface between [Busware CUL](https://shop.busware.de/product_info.php/cPath/1/products_id/29) (868MHz RF-Devices like ELV FS20, HMS, EM, etc.) and MQTT.
...
* [huABus](https://github.com/arboeh/huABus) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Home Assistant application (Add-on) and MQTT bridge for Huawei solar inverters (SUN2000/3000/5000).
...
* [mqtt2homekit](https://github.com/forty2/mqtt2homekit) ⭐ 38 | 🐛 4 | 🌐 JavaScript | 📅 2018-01-05 - Roughly the opposite of [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) ⭐ 358 | 🐛 39 | 🌐 JavaScript | 📅 2022-02-04: Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.

<!--lint enable double-link-->

* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,623 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-10 - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
* [zwavejs2mqtt](https://github.com/zwave-js/zwavejs2mqtt) ⭐ 1,238 | 🐛 116 | 🌐 Vue | 📅 2026-09-10 - Zwave to Mqtt gateway and Control Panel Web UI.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) ⭐ 358 | 🐛 39 | 🌐 JavaScript | 📅 2022-02-04 - Interface between [HAP-NodeJS](https://github.com/homebridge/HAP-NodeJS) ⭐ 2,722 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-22 and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
...
* [ioBroker](https://github.com/ioBroker) - Includes a [MQTT adapter](https://github.com/ioBroker/ioBroker.mqtt) ⭐ 58 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-06.
...
* [she - smart home engine](https://github.com/hobbyquaker/she) ⭐ 10 | 🐛 0 | 🌐 Svelte | 📅 2026-09-01 - Scriptable smart home automation engine with AI assistance.
...
* [lgtv2mqtt](https://github.com/hobbyquaker/lgtv2mqtt) ⭐ 114 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-05 - Interface between LG WebOS Smart TVs and MQTT.
...
* [chromecast-mqtt-connector](https://github.com/nohum/chromecast-mqtt-connector) ⭐ 46 | 🐛 1 | 🌐 Python | 📅 2026-08-26 - Control your Google Chromecast devices using MQTT.
* [onkyo2mqtt](https://github.com/owagner/onkyo2mqtt) ⭐ 40 | 🐛 2 | 🌐 Python | 📅 2021-03-30 - Interface between Onkyo AVR's EISCP network remote protocol and MQTT. Uses the onkyo-eiscp library.
...
* [yamaha-avr2mqtt](https://github.com/akentner/yamaha-avr2mqtt) ⭐ 11 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-01 - A simple adapter for connection Yamaha AVR to MQTT.
...
* [rpi-mqtt-monitor](https://github.com/hjelev/rpi-mqtt-monitor) ⭐ 318 | 🐛 9 | 🌐 Python | 📅 2026-06-26 - The easiest way to track your Raspberry Pi or Ubuntu computer system health and performance in Home Assistant via MQTT.
...
* [mqttwarn](https://github.com/jpmens/mqttwarn) ⭐ 979 | 🐛 40 | 🌐 Python | 📅 2026-07-22 - Subscribe to MQTT topics (with wildcards) and notify pluggable services.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,641 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
* [unifi2mqtt](https://github.com/hobbyquaker/unifi2mqtt) ⭐ 79 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-28 - Publish connected clients from Ubiquiti Unifi to MQTT.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,172 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
...
* [MQTT-Tiles](https://github.com/flespi-software/MQTT-Tiles) ⭐ 115 | 🐛 21 | 🌐 Vue | 📅 2026-06-23 - MQTT-based IoT dashboard visualization tool. Allows easy dashboards sharing. Works with any MQTT broker supporting the WSS protocol.
...
* [mqtt-dashboard](https://github.com/jmischler72/mqtt-dashboard) ⭐ 18 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-07 - Self-hostable MQTT dashboard/explorer with drag-and-drop panels like cron, button, log and topic browser to help interact and monitor MQTT topics.
...
* [mqtt-smarthome](https://github.com/mqtt-smarthome/mqtt-smarthome) ⭐ 454 | 🐛 9 | 📅 2022-02-04 - Smart home automation with MQTT as the central message bus - Architectural proposal.
...
* [mqttsa](https://github.com/stfbk/mqttsa) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2024-03-26 - Broker mis-configuration detection for cyber protection.
