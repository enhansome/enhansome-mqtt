...
* [EMQ X](https://github.com/emqx/emqx) ⭐ 16,716 | 🐛 208 | 🌐 Erlang | 📅 2026-09-14 - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
...
* [hbmqtt Broker](https://github.com/beerfactory/hbmqtt) ⭐ 818 | 🐛 102 | 🌐 Python | 📅 2022-07-24 - Python MQTT broker using asyncio.

<!--lint enable double-link-->

* [Moquette](https://github.com/moquette-io/moquette) ⭐ 2,456 | 🐛 141 | 🌐 Java | 📅 2026-08-31 - Java MQTT lightweight broker.
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 59 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - Async MQTT v5.0 broker in Rust with TCP, TLS, WebSocket, and QUIC transport, plus authentication, ACL, bridging, and session persistence.
...
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,614 | 🐛 68 | 🌐 C | 📅 2026-09-14 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoT DC3](https://github.com/pnoker/iot-dc3) ⭐ 1,262 | 🐛 32 | 🌐 Java | 📅 2026-09-08 - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,052 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
* [MQTT TUI](https://github.com/EdJoPaTo/mqttui) ⭐ 726 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - Simple lightweight terminal based MQTT monitor and publisher.
...
* [MQTT CLI](https://github.com/hivemq/mqtt-cli) ⭐ 363 | 🐛 13 | 🌐 Java | 📅 2026-09-14 - A command line interface for connecting various MQTT clients supporting MQTT 5.0 and 3.1.1.
...
* [VSMQTT](https://github.com/rpdswtk/vsmqtt) ⭐ 17 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14 - Simple MQTT client integrated in Visual Studio Code.
...
* [MQTTForge](https://github.com/ibrahimilkhan/mqtt-forge) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - Test console that builds a broker's topics into a live tree, shows every frame on the wire, and publishes by hand. Desktop app for macOS, Windows and Linux, or a single Docker image.
...
* [mqttv5](https://github.com/LabOverWire/mqtt-lib) ⭐ 59 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - Unified MQTT v5.0 CLI for publishing, subscribing, running a broker, and benchmarking with multi-transport support.
...
* [hbmqtt Client](https://github.com/beerfactory/hbmqtt) ⭐ 818 | 🐛 102 | 🌐 Python | 📅 2022-07-24 - Python MQTT client using asyncio.
...
* [ballerina-mqtt](https://github.com/ballerina-platform/module-ballerina-mqtt) ⭐ 105 | 🐛 2 | 🌐 Java | 📅 2026-09-13 - Ballerina MQTT client based on paho-mqtt.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,063 | 🐛 200 | 🌐 C# | 📅 2026-08-09 - MQTT client and broker .NET implementations.
* [HiveMQtt](https://github.com/hivemq/hivemq-mqtt-client-dotnet) ⭐ 96 | 🐛 13 | 🌐 C# | 📅 2026-09-14 - MQTT 5.0 compliant secure client with automatic back pressure management and TCP & WebSocket transport support.
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 59 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - Complete async MQTT v5.0 client and broker library for Rust with TCP, TLS, WebSocket, and QUIC support.
...
* [pubsubclient](https://github.com/knolleary/pubsubclient) ⭐ 4,013 | 🐛 567 | 🌐 C++ | 📅 2026-06-10 - A client library for the Arduino Ethernet Shield that provides support for MQTT.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,094 | 🐛 48 | 🌐 C++ | 📅 2026-09-14 - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
* [Bambuddy](https://github.com/maziggy/bambuddy) ⭐ 2,959 | 🐛 246 | 🌐 Python | 📅 2026-09-14 - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 172 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-14 - BLE-to-MQTT bridge for smart scales (23 brands) with Home Assistant auto-discovery. Reads weight + impedance, calculates body composition, publishes all 11 metrics with LWT and display precision. [Website](https://blescalesync.dev).
...
* [huABus](https://github.com/arboeh/huABus) ⭐ 8 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Home Assistant application (Add-on) and MQTT bridge for Huawei solar inverters (SUN2000/3000/5000).
...
* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,634 | 🐛 459 | 🌐 TypeScript | 📅 2026-09-14 - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
* [zwavejs2mqtt](https://github.com/zwave-js/zwavejs2mqtt) ⭐ 1,239 | 🐛 117 | 🌐 Vue | 📅 2026-09-14 - Zwave to Mqtt gateway and Control Panel Web UI.
...
* [ioBroker](https://github.com/ioBroker) - Includes a [MQTT adapter](https://github.com/ioBroker/ioBroker.mqtt) ⭐ 58 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-13.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,661 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-14 - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
* [unifi2mqtt](https://github.com/hobbyquaker/unifi2mqtt) ⭐ 79 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-10 - Publish connected clients from Ubiquiti Unifi to MQTT.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,178 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
...
* [mqtt-dashboard](https://github.com/jmischler72/mqtt-dashboard) ⭐ 18 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-14 - Self-hostable MQTT dashboard/explorer with drag-and-drop panels like cron, button, log and topic browser to help interact and monitor MQTT topics.
