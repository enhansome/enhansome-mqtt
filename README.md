...
* [EMQ X](https://github.com/emqx/emqx) ⭐ 16,705 | 🐛 193 | 🌐 Erlang | 📅 2026-09-11 - Scalable and Reliable Real-time MQTT Messaging Engine for IoT in 5G Era.
...
* [KMQTT](https://github.com/davidepianca98/KMQTT) ⭐ 296 | 🐛 25 | 🌐 Kotlin | 📅 2025-06-23 - Kotlin Multiplatform MQTT broker, both embeddable and standalone.
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 58 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 - Async MQTT v5.0 broker in Rust with TCP, TLS, WebSocket, and QUIC transport, plus authentication, ACL, bridging, and session persistence.

<!--lint enable double-link-->

* [tbmq](https://github.com/thingsboard/tbmq) ⭐ 761 | 🐛 7 | 🌐 Java | 📅 2026-09-11 - Open-source, scalable, fault-tolerant and durable messaging broker for millions of IoT devices.
...
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,614 | 🐛 66 | 🌐 C | 📅 2026-09-09 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoT DC3](https://github.com/pnoker/iot-dc3) ⭐ 1,252 | 🐛 32 | 🌐 Java | 📅 2026-09-08 - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
* [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents](https://github.com/ForestHubAI/edge-agents) ⭐ 102 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 orchestrates AI agents on Linux edge gateways with MQTT as a first-class workflow transport, running offline with local SLMs alongside cloud LLMs.
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,050 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows.
...
* [MQTT CLI](https://github.com/hivemq/mqtt-cli) ⭐ 363 | 🐛 14 | 🌐 Java | 📅 2026-09-11 - A command line interface for connecting various MQTT clients supporting MQTT 5.0 and 3.1.1.
...
* [VSMQTT](https://github.com/rpdswtk/vsmqtt) ⭐ 17 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-10 - Simple MQTT client integrated in Visual Studio Code.
...
* [MQTTForge](https://github.com/ibrahimilkhan/mqtt-forge) ⭐ 0 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10 - Test console that builds a broker's topics into a live tree, shows every frame on the wire, and publishes by hand. Desktop app for macOS, Windows and Linux, or a single Docker image.
...
* [mqttv5](https://github.com/LabOverWire/mqtt-lib) ⭐ 58 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 - Unified MQTT v5.0 CLI for publishing, subscribing, running a broker, and benchmarking with multi-transport support.
...
* [ballerina-mqtt](https://github.com/ballerina-platform/module-ballerina-mqtt) ⭐ 106 | 🐛 2 | 🌐 Java | 📅 2026-09-11 - Ballerina MQTT client based on paho-mqtt.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,060 | 🐛 197 | 🌐 C# | 📅 2026-08-09 - MQTT client and broker .NET implementations.
...
* [mqtt5](https://github.com/LabOverWire/mqtt-lib) ⭐ 58 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 - Complete async MQTT v5.0 client and broker library for Rust with TCP, TLS, WebSocket, and QUIC support.

<!--lint enable double-link-->

### Swift

* [CocoaMQTT](https://github.com/emqx/CocoaMQTT) ⭐ 1,752 | 🐛 112 | 🌐 Swift | 📅 2026-09-08 - MQTT for iOS and macOS written with Swift.
...
* [pubsubclient](https://github.com/knolleary/pubsubclient) ⭐ 4,014 | 🐛 568 | 🌐 C++ | 📅 2026-06-10 - A client library for the Arduino Ethernet Shield that provides support for MQTT.
...
* [Sonoff-Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,752 | 🐛 14 | 🌐 C | 📅 2026-09-11 - Firmware for ESP8266 devices with web-based configuration. ≈500 devices supported (not only Sonoffs).
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,091 | 🐛 50 | 🌐 C++ | 📅 2026-09-08 - MQTT gateway for ESP8266, ESP32, Sonoff RF Bridge or Arduino with bidirectional 433mhz/315mhz/868mhz, Infrared communications, BLE, beacons detection, mi flora, mi jia, LYWSD02, LYWSD03MMC, Mi Scale compatibility, SMS & LORA.
...
* [Bambuddy](https://github.com/maziggy/bambuddy) ⭐ 2,945 | 🐛 230 | 🌐 Python | 📅 2026-09-11 - Self-hosted management tool for Bambu Lab 3D printers using MQTT, with real-time monitoring, scheduling, and Home Assistant integration.
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 170 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-09 - BLE-to-MQTT bridge for smart scales (23 brands) with Home Assistant auto-discovery. Reads weight + impedance, calculates body composition, publishes all 11 metrics with LWT and display precision. [Website](https://blescalesync.dev).
...
* [hm2mqtt.js](https://github.com/hobbyquaker/hm2mqtt.js) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Interface between EQ-3's Homematic line of smarthome devices and MQTT. Supports Homematic IP.
...
* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,625 | 🐛 455 | 🌐 TypeScript | 📅 2026-09-11 - Allows you to use your Zigbee devices without the vendors (Xiaomi/TRADFRI/Hue) bridge/gateway.
* [zwavejs2mqtt](https://github.com/zwave-js/zwavejs2mqtt) ⭐ 1,239 | 🐛 116 | 🌐 Vue | 📅 2026-09-10 - Zwave to Mqtt gateway and Control Panel Web UI.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) ⭐ 358 | 🐛 39 | 🌐 JavaScript | 📅 2022-02-04 - Interface between [HAP-NodeJS](https://github.com/homebridge/HAP-NodeJS) ⭐ 2,722 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-22 and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
...
* [lgtv2mqtt](https://github.com/hobbyquaker/lgtv2mqtt) ⭐ 114 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-10 - Interface between LG WebOS Smart TVs and MQTT.
...
* [sonos2mqtt](https://github.com/svrooij/sonos2mqtt) ⭐ 84 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-06 - A bridge between Sonos and MQTT.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,647 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Xiaomi (Roborock) Vacuum Robots Firmware with MQTT and Webinterface.
...
* [unifi2mqtt](https://github.com/hobbyquaker/unifi2mqtt) ⭐ 79 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Publish connected clients from Ubiquiti Unifi to MQTT.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,173 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - Visualize time series (from sources such as: MQTT, Websockets, ZeroMQ, UDP, etc., supports data formats such as JSON, CBOR, BSON, Message Pack, etc.). It is a fast, powerful and intuitive cross-platform tool.
...
* [mqtt-dashboard](https://github.com/jmischler72/mqtt-dashboard) ⭐ 18 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-11 - Self-hostable MQTT dashboard/explorer with drag-and-drop panels like cron, button, log and topic browser to help interact and monitor MQTT topics.
